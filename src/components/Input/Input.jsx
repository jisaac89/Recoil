...
class Input extends React.Component {
    ...
    render() {
        ...
        let inputWrapperClass = classnames_1.default('r-Input', { 'w100': (props.block) }, { 'flex': (props.flex) }, { 'checked': (this.state.checked) }, props.className);
        let inputClass = classnames_1.default('r-Input__container', 'flohide', { 'no-title': (!props.title) }, { 'pt10': (props.type === 'textarea') });
