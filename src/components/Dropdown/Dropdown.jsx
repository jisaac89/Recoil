...
const DropdownButton = (props) => {
    return (<div className="r-DropdownButton">
        <Button className={props.className} onClick={props.onClick} icon={props.icon} checked={props.checked} type={props.theme} ghost={props.ghost}>
            {props.value}
        </Button>
      </div>);
};
const DropdownSelection = (props) => {
    return (<Layer overflow className={props.className}>
...
export default class Dropdown extends React.Component {
    ...
    render() {
        ...
        let dropdownClass = classNames('r-Dropdown', { 'e-open': (state.open) }, { 'dblock w100': (props.block) }, props.className);
