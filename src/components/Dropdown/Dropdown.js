...
export default class Dropdown extends Component{
  ...
  render() {
    ...
    switch (props.type) {
      case 'button':
        dropdownTypePartial = <DropdownButton className={buttonClass} onClick={self.toggleDrop.bind(self)} value={props.value} icon={props.icon} checked={state.open} theme={props.theme} ghost={props.ghost} flex={props.flex} />;
        break;
      case 'selection':
