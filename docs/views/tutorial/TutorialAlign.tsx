...
import { Align, Button, Toolbar, Layer } from '../../../src/index';
    ...
    let example = () => {
      return (
        <div>
          ...
          <p>
            By passing an <strong>array of numbers</strong> to the <strong>columns</strong> prop, we can easily adjust
            the width ratio.
          </p>
          ...
          <div className="ptb20">
            <div className="dark p10">
              <Align columns={this.state.columns} margin={'10px'}>
                <Layer theme="light" className="p20">
                  A
                </Layer>
                <Layer theme="light" className="p20">
                  B
          ...
          <p>
            To align elements vertically, pass the <strong>vertical</strong> prop.
          </p>
          <div className="pt20">
            <div className="dark h300px p10">
              <Align vertical margin={'10px'} columns={this.state.columns}>
                <Layer fill theme="light" className="p10">
                  A
                </Layer>
                <Layer fill theme="light" className="p10">
                  B
